...
namespace Vespertan.TemplateEditor
{
    ...
    /// </example>
    /// </remarks>
    public class VesDelegateCommand<T> : VesDelegateCommandBase
    {
        readonly Action<T> _executeMethod;
        Func<T, bool> _canExecuteMethod;

        /// <summary>
        /// Initializes a new instance of <see cref="VesDelegateCommand{T}"/>.
        /// </summary>
        /// <param name="executeMethod">Delegate to execute when Execute is called on the command. This can be null to just hook up a CanExecute delegate.</param>
        /// <remarks><see cref="CanExecute"/> will always return true.</remarks>
        public VesDelegateCommand(Action<T> executeMethod)
        ...
        public VesDelegateCommand(Action<T> executeMethod, Func<T, bool> canExecuteMethod)
            : base()
        {
        ...
        public VesDelegateCommand<T> ObservesProperty<TType>(Expression<Func<TType>> propertyExpression)
        {
        ...
        /// <returns>The current instance of DelegateCommand</returns>
        public VesDelegateCommand<T> ObservesCanExecute(Expression<Func<bool>> canExecuteExpression)
        {
